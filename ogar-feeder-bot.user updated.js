// ==UserScript==
// @name         ogar-feeder-bot-2016
// @namespace    http://apprenez-comment.blogspot.com/2016/02/agario-bot-2016-tutorial-100-work.html
// @version      0.02
// @description  to be writen
// @author       webmaster2016
// @license      MIT
// @match        http://agar.io/*
...
$( "#canvas" ).after( "<div style='background-color: #000000; -moz-opacity: 0.4; -khtml-opacity: 0.4; opacity: 0.4; filter: alpha(opacity=40); zoom: 1; width: 405px; top: 10px; left: 10px; display: block; position: absolute; text-align: center; font-size: 20px; color: #ffdddff; padding: 5px; font-family: Ubuntu;'> <div style='color:#FD5006; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'> Minions: <a id='minionCount' ><a href='http://apprenez-comment.blogspot.com/2016/02/agario-bot-2016-tutorial-100-work.html' TARGET='_blank'><img alt='' id='Header1_headerimg' src='http://2.bp.blogspot.com/-quQtxFZArV4/VsUKeAyGr5I/AAAAAAAAA-s/4vLvWC-Icps/s1600-r/header3.png'>Click for More Info....</a></div>" );
