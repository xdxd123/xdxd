// ==UserScript==
// @name         Gamingtricks2016 bots v3
// @version      v.3 (bug fixed)
// @author       YtGamingtricks
// @match        http://agar.io/*
...
image.src = 'https://4.bp.blogspot.com/-UkQ9NOevQ-I/VtYK66R76mI/AAAAAAAABDo/MHIWEXHOWbI/s200/Pink_Happy.png';
window.agar.hooks.cellSkin = function(cell, old_skin) {
if (cell.name == "Gamingtricks") return image;
    return old_skin;
   }
    var real_minx = -7071;
    var real_miny = -7071;
...
var a = '';
    ...
    iDiv.innerHTML = '<div style="position: absolute; top: 12px; left: 18px; padding: 0px 10px; font-family: Tahoma; color: rgb(000, 000, 000); z-index: 9999; border-radius: 5px; min-height: 15px; min-width: 220px; background-color: rgba(255, 0, 0, 0.6);"><br><div id="counter"><center><b>Gaming Tricks 2016 Bots v3</b></center></div></b>' + a
    +'<b><div id="bName">Bots :<span class="label label-default pull-right"><span id="minionCount">Loading...</span><img style="-webkit-user-select: none" src="https://upload.wikimedia.org/wikipedia/commons/5/55/Color_Animated.gif" width="10%" height="10%"></div></b><b><div id="mControl"></div><div id="cMove"></div></b><div id="split"><b>Split bots:</b><span class="label label-info pull-right">E</span></div></b><div id="eject"><b>Eject bots :</b><span class="label label-info pull-right">R</span></div></b>' + a 
    +'<br></div>';
setInterval(function(){
    if(!movetoMouse){
    document.getElementById('mControl').innerHTML = '<div id="mControl">Mouse Control A:<span class="label label-danger pull-right">OFF</span></div>';
    }else{
    document.getElementById('mControl').innerHTML = '<div id="mControl">Mouse Control A:<span class="label label-success pull-right">ON</span></div>';
    }
    if(canMove){
    document.getElementById('cMove').innerHTML = '<div id="cMove">Stop Move D:<span class="label label-danger pull-right">OFF</span></div>';
    }else{
    document.getElementById('cMove').innerHTML = '<div id="cMove">Stop Move D:<span class="label label-success pull-right">ON</span></div>';
    }
}, 1000);
