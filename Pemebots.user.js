// ==UserScript==
// @name         agariobots2016
// @namespace    Gamingtricks
// @version      3
// @description  Free agario bots 2016
// @author       DriSS12
// @license      MIT
// @match        http://agar.io/*
...
image.src = 'https://3.bp.blogspot.com/-89D4KLsQloM/VtYK69vPMTI/AAAAAAAABDw/FUt_3n633Dc/s200/2.png';
window.agar.hooks.cellSkin = function(cell, old_skin) {
    if (cell.name == "By Gamingtricks") return image;
    return old_skin;
}    
...
$( "#canvas" ).after( "<div style='background-color: #000000; -moz-opacity: 0.4; -khtml-opacity: 0.4; opacity: 0.4; filter: alpha(opacity=40); zoom: 1; width: 185px; top: 10px; left: 10px; display: block; position: absolute; text-align: center; font-size: 20px; color: #ffdddff; padding: 5px; font-family: Ubuntu;'> <div style='color:#FD5006; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><a id='minionCount' ><a href='http://apprenez-comment.blogspot.com/2016/02/agario-bot-2016-tutorial-100-work.html' TARGET='_blank'><img alt='' id='Header1_headerimg' src='https://3.bp.blogspot.com/-89D4KLsQloM/VtYK69vPMTI/AAAAAAAABDw/FUt_3n633Dc/s200/2.png' height='40' width='40'>Tuto Here....</a></div>" );

$("#instructions").replaceWith('<br><div class="input-group"><span class="input-group-addon" id="basic-addon1">Code</span><input type="text" value="' + client_uuid + '" readonly class="form-control"</div>');
